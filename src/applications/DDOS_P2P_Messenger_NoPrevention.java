...
public class DDOS_P2P_Messenger_NoPrevention extends Application{
    ...
    public static final int DDOS_INTERVAL = 125;


    /** Application ID */
    public static final String APP_ID = "cs.standrews.ac.uk.DDOS_P2P_Messenger_NoPrevention";
    ...
    public DDOS_P2P_Messenger_NoPrevention(Settings s) {
    ...
    public DDOS_P2P_Messenger_NoPrevention(DDOS_P2P_Messenger_NoPrevention em) {
        super(em);
    ...
    public Message handle(Message msg, DTNHost host) {
        ...
        if (host.getName().startsWith("o")) {
            if (msg.getId().startsWith("ddos") && msg.getTo() == host) {
                super.sendEventToListeners("GotDDOS", null, host);
                return null;
            }
        }
    ...
    public void update(DTNHost host) {
        ...
        if (curTime - this.lastMSg >= this.interval && host.getName().startsWith("p")) {
            DTNHost to = randomHost(host);
    ...
    public Application replicate() {
        return new DDOS_P2P_Messenger_NoPrevention(this);
    }
