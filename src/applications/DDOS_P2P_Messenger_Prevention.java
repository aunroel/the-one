...
public class DDOS_P2P_Messenger_Prevention extends Application{
    ...
    /** Application ID */
    public static final String APP_ID = "cs.standrews.ac.uk.DDOS_P2P_Messenger_Prevention";
    ...
    public DDOS_P2P_Messenger_Prevention(Settings s) {
    ...
    public DDOS_P2P_Messenger_Prevention(DDOS_P2P_Messenger_Prevention em) {
        super(em);
    ...
    public Application replicate() {
        return new DDOS_P2P_Messenger_Prevention(this);
    }
