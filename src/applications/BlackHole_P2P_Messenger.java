...
public class BlackHole_P2P_Messenger extends Application{
    ...
    /** Application ID */
    public static final String APP_ID = "cs.standrews.ac.uk.BlackHole_P2P_Messenger";
    ...
    public BlackHole_P2P_Messenger(Settings s) {
    ...
    public BlackHole_P2P_Messenger(BlackHole_P2P_Messenger em) {
        super(em);
    ...
    public void update(DTNHost host) {
        ...
        if (host.getName().startsWith("o") || host.getName().startsWith("s")) {
            return;
        }
    ...
    public Application replicate() {
        return new BlackHole_P2P_Messenger(this);
    }
