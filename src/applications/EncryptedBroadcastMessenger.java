...
public class EncryptedBroadcastMessenger extends Application{
    ...
    /** Application ID */
    public static final String APP_ID = "cs.standrews.ac.uk.EncryptedBroadcastMessenger";
    ...
    public EncryptedBroadcastMessenger(Settings s) {
    ...
    public EncryptedBroadcastMessenger(EncryptedBroadcastMessenger em) {
        super(em);
    ...
    public Application replicate() {
        return new EncryptedBroadcastMessenger(this);
    }
