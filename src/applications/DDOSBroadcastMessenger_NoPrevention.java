...
public class DDOSBroadcastMessenger_NoPrevention extends Application{
    ...
    /** Application ID */
    public static final String APP_ID = "cs.standrews.ac.uk.DDOSBroadcastMessenger_NoPrevention";
    ...
    public DDOSBroadcastMessenger_NoPrevention(Settings s) {
    ...
    public DDOSBroadcastMessenger_NoPrevention(DDOSBroadcastMessenger_NoPrevention em) {
        super(em);
    ...
    public Application replicate() {
        return new DDOSBroadcastMessenger_NoPrevention(this);
    }
